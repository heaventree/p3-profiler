...
/**
 * Boot everything at plugins_loaded so we catch hooks registered during
 * the plugin-loading phase.  Priority 1 puts us before almost every plugin.
 */
add_action('plugins_loaded', static function (): void {
    // Admin UI, AJAX, settings — always boot
    HTP_Admin::get_instance()->boot();

    // Profiling engine — only for the designated IP
