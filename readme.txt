...
* IP-scoped: only profiles requests from your IP

== Installation ==

1. Upload the heaventree-profiler folder to wp-content/plugins/
2. Activate the plugin
3. Go to Tools → Perf Profiler

== How to profile ==

1. Go to Tools → Perf Profiler
2. Click Start profiling — this records your IP
3. Browse the admin pages that are slow (especially WooCommerce pages)
4. Click Stop profiling
5. View results in the Profiles tab
...
* Anthropic Claude (console.anthropic.com) — recommended, claude-3-5-haiku-20241022
...
* Hook-based timing engine replacing deprecated declare(ticks=1) approach
* Added WooCommerce-specific profiling
* Added database query profiling
* Added AI analysis via Anthropic Claude and OpenAI
* Modern vanilla-JS admin UI, no jQuery UI dependency
